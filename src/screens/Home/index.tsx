...
export const Home: React.FC<{ navigation: HomePageNavigationProp }> = ({ navigation }) => {
  ...
  const [dadosMusicas, setDadosMusicas] = useState<MusicaCardData[]>([]); // NOVO

  useEffect(() => {
    carregarArtistasAleatorios();
    carregarAlbunsAleatorios();
    carregarMusicasAleatorias(); // NOVO
  }, []);
  ...
  const carregarAlbunsAleatorios = async () => {
    try {
      const albumIds = [
        "9410100","9410086","9410096","192713912","273425942","192713382","65728092",
        "217795","6872781","620594","92441","91973","1339808","426206047","6637634",
        "262689412","54853512","1454128","1382877","262577432","262578012","978395",
        "433252","431105","430543","164392742","127270232","1219432","8015598","845711302",
        "318323957","67112162","4502741","697730","78721","944848","50537252","14713400",
        "92118","338903","303391","251184952","301190","11102328","252650682","98711",
        "5287781","5424121","8322886","6010349","5956692","266772012","14344084","253927",
        "334252","334249","334244","334342","334196","334191","334284","334285","664052151",
        "583192942","41645391","53098502","9920344","9784060","9789862","10966122","51001312",
        "7776833","1441212","5814031","68614721","6916355","1262014","179304232","7019471",
        "72123","708674","10595425","10588255","10748338","6551689","39555481","8980335",
        "11747504","15151267","7515539","15151447","15151449","14379438","382650","89752",
        "309640","309600","309599","145197592","97430","1344559",
      ];
  ...
  // 🔥 NOVO — CARREGAR MÚSICAS RECOMENDADAS
  const carregarMusicasAleatorias = async () => {
    try {
      const musicIds = [
        "3135556", "1109731", "916424", "737582812", "527727312",
        "1109739", "739119142", "15245173", "67630369", "6462793"
      ];
  ...
  // 🔥 Ir para Player
  const navegarParaMusica = (musica: MusicaCardData) => {
    navigation.navigate("Player", { musica });
  };
        ...
        {dadosMusicas.map((item, index) => {
          ...
          const animarEPressionar = () => {
            Animated.sequence([
              ...
              navegarParaMusica(item); // 🔥 Agora abre o Player
            });
          };
